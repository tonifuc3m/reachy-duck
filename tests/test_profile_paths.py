...
import reachy_duck.personality as headless_mod
import reachy_duck.profile_store as profile_store_mod
from reachy_duck.config import DEFAULT_PROFILES_DIRECTORY, config
from reachy_duck.personality import (
    list_personalities,
)
from reachy_duck.profile_store import read_profile, write_profile, read_profile_from_directory
...
#     \spaces--pollen-robotics--reachy_duck
...
#   back to the budget: 101 + len("reachy_duck\") (29) = 130.
#
...
def test_explicit_default_profile_does_not_fall_back_to_itself(
    ...
    with caplog.at_level(logging.WARNING, logger="reachy_duck.prompts"):
