...
import reachy_duck.tool_spaces as tool_spaces_mod
...
def _reload_core_tools() -> ModuleType:
    for module_name in list(sys.modules):
        if module_name.startswith("reachy_duck.tools."):
            sys.modules.pop(module_name, None)

    sys.modules.pop("reachy_duck.tools.core_tools", None)
    return importlib.import_module("reachy_duck.tools.core_tools")
