...
from reachy_duck.profile_toolsets import read_profile_tool_names
from reachy_duck.tools.tool_constants import SystemTool


if TYPE_CHECKING:
    from reachy_duck.mcp_client import RemoteMcpToolClient
    from reachy_duck.tools.background_tool_manager import BackgroundToolManager
...
_EXTERNAL_TOOL_MODULE_NAMESPACE = "reachy_duck._external_tools"
...
def _load_enabled_tools(tool_names: list[str], remote_tool_names: set[str]) -> List[type[Tool]]:
    ...
    for tool_name in tool_names:
        ...
        shared_module_path = f"reachy_duck.tools.{tool_name}"
        try:
