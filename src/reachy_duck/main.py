...
def main() -> None:
    ...
    if args.command == "tool-spaces":
        from reachy_duck.tool_spaces import handle_tool_spaces_command
...
def run(
    ...
    from reachy_duck.moves import MovementManager
    ...
    def build_handler(startup_voice: Optional[str] = None) -> ConversationHandler:
        ...
        from reachy_duck.huggingface_realtime import HuggingFaceRealtimeHandler
...
class ReachyDuck(ReachyMiniApp):  # type: ignore[misc]
